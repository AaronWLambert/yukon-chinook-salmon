...
ggplot(full_rmseDF, aes(x = Day, y = RMSE, fill = Version))+
  ...
  labs(title = "RMSE by Day, across Years",
       fill = "")+
  coord_cartesian(ylim = c(13000,18000))+
...
rmseYearDF_ver3.3 <- data.frame("Year" = testYears, 
                                ...
                                "Version" = "Ver 3.3")
rmseYearDF_ver3.4 <- data.frame("Year" = testYears, 
                                "RMSE" = RetroList_ver3.4$RMSE_by_year_vect,
                                "Version" = "Ver 3.4")
rmseYearDF_ver3.5 <- data.frame("Year" = testYears, 
                                "RMSE" = RetroList_ver3.5$RMSE_by_year_vect,
                                "Version" = "Ver 3.5")
...
outPlots(outputList = model.output ,CAN_hist = CAN_hist,GSI = FALSE, Retrospective = FALSE)
# List to hold plots
