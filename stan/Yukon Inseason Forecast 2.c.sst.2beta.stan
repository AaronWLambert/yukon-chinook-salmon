// Yukon King Inseason Forecast Version 2.c.sst.2beta
//Notes: 
...
transformed parameters{
 ...
 for (i in 1:n_yearPSS){
 ln_predPSS[i] = alpha + beta * cumHistPSS[i] + beta2 * cumHistPSS[i]*may_sst_hist[i];}
 ...
 //
 ln_curr_predPSS = alpha + beta * cum_current_PSS + beta2 * cum_current_PSS * may_sst_curr ;
