...
parameters {
  ...
  // Midpoint deviations regression param
  real  alpha_env;
  real  beta_sst;
  real  beta_air;
...
transformed parameters{
  ...
  dev_predMP = alpha_env + beta_sst * may_sst_hist + beta_air * april_air_hist;
  
  // This years prediction
  curr_dev_predMP = alpha_env + beta_sst * may_sst_curr + beta_air * april_air_curr;
...
model {
  ...
  dev_hist ~ normal(dev_predMP, sigma_env);
...
generated quantities{
  ...
  // post_curr_predDev = normal_rng(curr_dev_predMP, sigma_env);
