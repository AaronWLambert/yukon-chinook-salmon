// Yukon King Inseason Forecast Version 6.prop.2
//Notes: Version using estimated proportion shifted by deviation based on SST ONLY
...
transformed parameters{
  ...
  // This years estimated EOS PSS abund
