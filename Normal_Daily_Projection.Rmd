...
PSS <- read_xlsx(file.path(dir.data,"ADFG PSS Daily/Yukon Escapement Daily 27Aug23.xlsx"),skip = 3)

ESS <- read_xlsx(file.path(dir.data,"ADFG Eagle Daily/Yukon Escapement Daily Eagle 27Aug23.xlsx"),skip = 3)
...
myDay <- myDay_func(Month = 6, Day = 30)
